/*-----------------------------------------------------------------------
  ...
  File: Home_Automation_Switch.ino
  ------------------------------------------------------------------------
  Description:
  ...
  control the status of LEDs. It can work as Acess Point also.
  ------------------------------------------------------------------------
...
void setup(void) {
  ...
  while (WiFi.status() != WL_CONNECTED) {
    Serial.println("Acess-Point is not connected. You can use ESP8266 as WiFiClient");
    delay(500);
    Serial.print(".");
  }
